...
//sql param
param administratorLogin string = uniqueString(name, location, subscription().tenantId, 'sqladmin')
@secure()
param administratorPassword string // Autogenerated in main.parameters.json
